...
export default function Home() {
  useSeo({ title: "Saltwater Fish Pro | A Stability-First Field Guide", description: "Plan, care for, and improve a mixed saltwater aquarium with stability-first guides for water, equipment, livestock, and long-term system care.", path: "/", image: "https://saltwaterfishpro.com/images/hero-mixed-reef.jpg", schema: publicationSchema });
  return (
    <div className="site-shell">
      ...
      <main>
        ...
        <section className="problem-section"><div className="problem-section__intro"><span className="eyebrow">When the tank feels off</span><h2>Start with a better question.</h2><p>Skip the quick fix. Find a guide that helps you observe the system, isolate the change, and make the next move with confidence.</p></div><div className="problem-links">{[{ problem: "Cloudy water", href: "/articles/mixed-system-water-testing-workflow" }, { problem: "Unwanted algae", href: "/articles/algae-diagnostic-before-treatment" }, { problem: "Unstable parameters", href: "/articles/water-changes-and-stability" }, { problem: "Fish acting differently", href: "/articles/quarantine-decision-framework" }, { problem: "Coral decline", href: "/troubleshoot" }, { problem: "New-tank uncertainty", href: "/articles/cycling-a-mixed-saltwater-aquarium" }].map(({ problem, href }) => <Link href={href} className="problem-link" key={problem}><span>{problem}</span><ArrowUpRight size={18} /></Link>)}</div></section>
